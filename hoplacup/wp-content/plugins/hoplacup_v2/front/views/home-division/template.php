...
<!--                            --><?php //echo($currentTime) ?>
                        ...
                        <?php foreach ($matchs_du_jour  as $match) :
                            ...
                            <tr>
                                <td class="logoEquipe">
                                    <picture>
                                        <img src="<?= dirname(dirname(plugin_dir_url(__FILE__))) ?>/images/logos_clubs/<?= $static_logo1 ?>" alt="Logo <?= $match->Nom_Equipe1 ?>">
                                    </picture>
                                </td>
                                ...
                                <td class="logoEquipe">
                                    <picture>
                                        <img src="<?= dirname(dirname(plugin_dir_url(__FILE__))) ?>/images/logos_clubs/<?= $static_logo2 ?>" alt="Logo <?= $match->Nom_Equipe2 ?>">
                                    </picture>
                                </td>
                            </tr>
                        <?php endforeach; ?>
